...
function EditModal(props: {
  ...
  const { modal, setReload, setModal, selectedProduct, handleChange, ...rest } =
    props;
      ...
      >
        <div className="relative w-full max-w-4xl max-h-full">
          ...
          <form
            ...
            action="#"
            className="relative bg-white rounded-lg shadow dark:bg-green-700"
          >
            {/* <!-- Modal header --> */}
                    ...
                    <section>
                      <div className="col-md-4 ">
                        {preview ? (
                          ...
                          <img
                            src={`http://localhost:8090/images/users/${selectedProduct.image}`}
                            width={244}
                            height={344}
                          />
                        )}
